...
////////////////////////////////////////////////////////
// GENERATES 6.6 MILLION
//   menu itemIds are randomized from 1 to 100 million
////////////////////////////////////////////////////////
const requiredCategoriesPrinter = () => {
  const fil = fs.createWriteStream('smallRequiredCategories.csv');
  let categoryId = 1;
  const maxLimit = 6600000;
  ...
  const writer = () => {
    ...
    while (categoryId <= maxLimit && result) {
      ...
      const data = dataFuncs.generateRequiredChoiceCategories(categoryId, (Math.floor(Math.random() * (20000000 - 1) + 1)));
